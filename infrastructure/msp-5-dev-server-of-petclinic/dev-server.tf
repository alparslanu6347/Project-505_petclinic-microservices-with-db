...
//Amazon Linux 2023 - t3a.medium
//Enabled with Git, Java 11, Docker and Docker Compose
...
resource "aws_launch_template" "PetclinicServerLT" {
  ...
  user_data = filebase64("petclinicserver-userdata.sh") # filebase64 reads the contents of a file at the given path and returns them as a base64-encoded string.
}
